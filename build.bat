...
%msbuild% LF.Toolkit.Data.Dapper.EF\LF.Toolkit.Data.Dapper.EF.csproj /p:Configuration=Release /t:Clean;Rebuild /p:OutputPath=..\build\LF.Toolkit.Data.Dapper.EF
FOR /F "tokens=*" %%G IN ('DIR /B /AD /S obj') DO RMDIR /S /Q "%%G"
